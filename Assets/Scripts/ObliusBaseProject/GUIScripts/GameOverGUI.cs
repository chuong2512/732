		...
		/*AdNetworksManager.instance.ShowRewardedVideo ((bool value) => 
			{
				if(value){
                    ...
                    ScoreHandler.instance.increaseSpecialPoints(Random.Range(ObliusGameManager.instance.minCoinsToAddOnReward
                        , ObliusGameManager.instance.maxCointsToAddOnReward));
